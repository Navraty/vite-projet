...
function Signup(){
  return (
    <div className="flex h-screen bg-[#38329E] ">
        ...
        <span className="bg-gray-100  text-sm p-2 text-blue-500 rounded-lg">E241</span>
            ...
            <form action="">
                <div className="mb-5  gap-4 flex py-2 flex-col">
                    <label for="name" className="block mb-2 ">Nom complet</label>
                ...
                <p className="py-2">En vous inscrivant, vous accepter les conditions d'utilisation et la <br /> politique de confidentialité de </p>

                <Link to="/"><button className="w-full bg-blue-600 text-white p-4 rounded-md">S'inscrire</button></Link>
                <span className="flex gap-3 py-2 mx-10">Vous avez déjà un compte ? <Link to="/" className="text-blue-600">Connectez-vous</Link></span>
            </form>
        </div>
